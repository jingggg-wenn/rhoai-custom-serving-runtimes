...
- [ServingRuntime + InferenceService](#ui-screenshots---servingruntime--inferenceservice)
  - [OpenShift AI 3.5.0](#openshift-ai-350)
  - [OpenShift AI 3.4.3](#openshift-ai-343)
- [LLMInferenceServiceConfig + LLMInferenceService](#ui-screenshots---llminferenceserviceconfig--llminferenceservice)
  - [OpenShift AI 3.5.0](#openshift-ai-350-1)
  - [OpenShift AI 3.4.3](#openshift-ai-343-1)

## UI Screenshots - ServingRuntime + InferenceService
...
## UI Screenshots - LLMInferenceServiceConfig + LLMInferenceService
